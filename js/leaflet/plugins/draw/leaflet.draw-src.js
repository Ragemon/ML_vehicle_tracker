...
L.drawLocal = {
	draw: {
		toolbar: {
			...
			buttons: {
				polyline: 'Draw tracking route',
				polygon: 'Draw tracking region',
		...
		handlers: {
			...
			polyline: {
				...
				tooltip: {
					start: 'Click to start drawing label.',
					cont: 'Click to continue drawing label.',
					end: 'Click last point to finish label.'
				}
			},
			rectangle: {
				tooltip: {
	...
	edit: {
		...
		handlers: {
			edit: {
				tooltip: {
					text: 'Drag handles, or marker to edit label.',
